const projectsInfo = [
  {
    ...
    description: 'Portfolio feito em React para exposição de projetos, informações de contato e um pouco sobre mim.',
  ...
  },
  {
    ...
    image: 'mobile-detail-light.png',
    demo: 'https://countries-bmp.vercel.app/',
    repository: 'https://github.com/braien-machado/rest-countries-api-with-color-theme-switcher',
    stacks: [
      'React',
      'Sass',
      'Airbnb style',
