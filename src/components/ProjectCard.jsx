...
export default function ProjectCard(props) {
  ...
  if (!name) {
    return (
      <div key={index} className='border-zinc-700 border-2 hover:border-gray-300 shadow-md duration-300 rounded-md w-4/5 p-2 mb-4'>
  ...
  return (
    <div key={index} className='border-zinc-700 border-2 hover:border-gray-300 duration-300 shadow-md rounded-md w-4/5 p-2 mb-4 lg:flex lg:flex-row-reverse lg:justify-end lg:items-center'>
      ...
      <div className='lg:w-1/2 mt-2 lg:mt-0 lg:mr-2 lg:text-center lg:flex lg:h-full lg:flex-col lg:justify-around'>
        ...
        <div className='mt-2 flex justify-evenly flex-wrap'>
          <a  href={demo} target='_blank' rel='noreferrer'>
            <button className='p-2 w-40 border-2 border-zinc-700 hover:bg-zinc-700 text-gray-500 hover:text-white hover:underline rounded-md duration-300 mb-2'>Demonstração</button>
          </a>
          <a href={repository} target='_blank' rel='noreferrer'>
            <button className='p-2 w-40 border-2 border-zinc-700 hover:bg-zinc-700 text-gray-500 hover:text-white hover:underline rounded-md duration-300'>Repositório</button>
          </a>
        </div>
      </div>
    </div>
